...
const getWeatherData = async () => {
    try {
        ...
        const weatherData = await axios.get(`https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&hourly=temperature_2m,apparent_temperature,precipitation_probability,is_day&current_weather=true`);
...
console.log(precip, weatherCode);
</script>